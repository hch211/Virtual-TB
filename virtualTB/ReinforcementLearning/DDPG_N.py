...
for i in range(len(gamma)):
    ...
    for j in range(7):
        new_logger = configure(tmp_path, ["csv", "tensorboard"],
                               log_suffix="_gamma={}_batch_size={}_noise=N_{}".format(gamma[i], batch_size[i], j))
        ...
        model.save("./DDPG_model01/gamma={}_reward_scale={}_noise=N_{}.pkl".format(gamma[i], batch_size[i], j))
