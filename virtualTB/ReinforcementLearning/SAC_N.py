...
for i in range(len(gamma)):
    ...
    tmp_path = "./SAC_model01/"
    
    for j in range(7):
        new_logger = configure(tmp_path, ["csv", "tensorboard"],
                               log_suffix="_gamma={}_reward_scale={}_noise=N_{}".format(gamma[i], reward_scale[i], j))
        ...
        model.save("./SAC_model01/gamma={}_reward_scale={}_noise=N_{}.pkl".format(gamma[i], reward_scale[i], j))
